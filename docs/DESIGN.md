...
**`EntityListing`** (`EntityListing.vue`) — panel de lista: header `border-b bg-surface-2 px-4 py-3` con eyebrow + card-title; body scrollable `p-2`; footer `border-t p-2`; escalado responsive por container queries.
