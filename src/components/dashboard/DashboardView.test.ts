...
vi.mock('@/composables/useDashGrid', () => ({
  ...
  applyGapToPixel: vi.fn(
    (xPercent, yPercent, wPercent, hPercent, containerWidth, containerHeight, _gap) => ({
...
vi.mock('@/stores/dashboard', () => ({
  useDashboardStore: () => ({
    get layout() {
      return [{ i: 'habits', xPercent: 0, yPercent: 0, wPercent: 0.5, hPercent: 0.4 }]
    },
