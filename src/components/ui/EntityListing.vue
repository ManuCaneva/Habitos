...
<template>
  <div :data-testid="panelTestId" class="h-full flex flex-col">
    <div
      class="shrink-0 bg-surface-2 px-3 py-2 border-b border-hairline flex items-baseline justify-center gap-1.5"
