...
export function buildTokenExchangePayload(params: TokenExchangePayload): URLSearchParams {
...
export function buildRefreshPayload(params: RefreshPayload): URLSearchParams {
  return new URLSearchParams({
